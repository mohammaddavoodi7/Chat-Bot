...
def message_probability(user_message, recognised_words, single_response=False, required_words=[]):
    ...
    # Calculates the percent of recognised words in the message
...
def check_all_messages(message):
    ...
    # Responses ---------------------------------------------------
        ...
        response('GodBy See you soon', [
            'i', 'hope', 'see', 'you', 'later', 'GL'], required_words=['by', 'see', 'you'])
        response('Can you Help me to code?', [
            'you', 'can', 'learn', 'in', 'youtube'], required_words=['help', 'code'])
